...
class ActorsControllerTest < ActionController::TestCase
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post :create, actor: { first_name: @actor.first_name, last_name: @actor.last_name, last_update: @actor.last_update }
    end
  ...
  test "should update actor" do
    patch :update, id: @actor, actor: { first_name: @actor.first_name, last_name: @actor.last_name, last_update: @actor.last_update }
    assert_redirected_to actor_path(assigns(:actor))
  end
