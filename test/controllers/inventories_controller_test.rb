...
class InventoriesControllerTest < ActionController::TestCase
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post :create, inventory: { film_id: @inventory.film_id, last_update: @inventory.last_update, store_id: @inventory.store_id }
    end
  ...
  test "should update inventory" do
    patch :update, id: @inventory, inventory: { film_id: @inventory.film_id, last_update: @inventory.last_update, store_id: @inventory.store_id }
    assert_redirected_to inventory_path(assigns(:inventory))
  end
